...
import (
	...
	"github.com/gocrane/crane-scheduler/pkg/cloudsdk/qcloud/metrics"
)
...
var (
	...
	*/
	...
	// node view
	K8sNodeCpuUsagePercentMetric = "K8sNodeCpuUsage"
	K8sNodeMemUsagePercentMetric = "K8sNodeMemUsage"

	// 由于barad 比较坑，因此这里其实都是对应一个指标名，然后传递不同 period 就是不同的指标序列
	K8sNodeCpuUsageAvg5mPercentMetric    = K8sNodeCpuUsagePercentMetric
	K8sNodeMemUsageAvg5mPercentMetric    = K8sNodeMemUsagePercentMetric
	K8sNodeCpuUsageMaxAvg1hPercentMetric = "K8sNodeCpuUsageMax"
	K8sNodeMemUsageMaxAvg1hPercentMetric = "K8sNodeMemUsageMax"
	K8sNodeCpuUsageMaxAvg1dPercentMetric = "K8sNodeCpuUsageMax"
	K8sNodeMemUsageMaxAvg1dPercentMetric = "K8sNodeMemUsageMax"
...
func (qcc *QCloudMonitorClient) UpdateQCloudAssumedCredential(secretId, secretKey, token string) {
	qcc.clientLock.Lock()
	defer qcc.clientLock.Unlock()
	qcc.config.Credential.UpdateQCloudAssumedCredential(secretId, secretKey, token)
}
...
func (qcc *QCloudMonitorClient) getQCloudCredential() (*common.Credential, error) {
...
func (qcc *QCloudMonitorClient) getClient() (*cm.Client, error) {
	...
	cred, err := qcc.getQCloudCredential()
	if err != nil {
		return nil, err
	}
	if qcc.client == nil {
