...
func (cred *FakeCred) DisableRefresh() {
	panic("implement me")
}

func (cred *FakeCred) UpdateQCloudAssumedCredential(secretId, secretKey, token string) *common.Credential {
	panic("implement me")
}
...
func (cred *FakeCred) GetQCloudCredential() (*common.Credential, error) {
	cred.lock.Lock()
