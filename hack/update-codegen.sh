...
bash "${CODEGEN_PKG}"/generate-groups.sh "client,lister,informer" \
  github.com/gocrane/crane-scheduler/pkg/apis/generated \
  github.com/gocrane/crane-scheduler/pkg/apis \
  "scheduling:v1alpha1" \
...
cp -r $SCRIPT_ROOT/github.com/gocrane/crane-scheduler/* $SCRIPT_ROOT
